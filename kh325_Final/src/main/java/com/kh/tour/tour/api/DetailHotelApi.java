...
//		practice4.heritageInfo_Url("1", "2", "3");
		DetailHotelApi.callCurrentDetailHotelByXML();
	}
...
//						System.out.println(contentTypeId);
						...
						if(contentTypeId == 32) {
						URL url2 = new URL(DetailHotelApi.hotelUrl(serviceKey, contentId, contentTypeId).toString());
...
//						System.out.println("\nCurrent Element2 : " + node.getNodeName());
						if (node2.getNodeType() == Node.ELEMENT_NODE) {
							...
							String accomCountLodging = getStrData(eElement2, "accomcountlodging");
							String benikia = getStrData(eElement2, "benikia");
							String checkInTime = getStrData(eElement2, "checkintime");
							String checkOutTime = getStrData(eElement2, "checkouttime");
							String chkCooking = getStrData(eElement2, "chkcooking");
							String foodPlace = getStrData(eElement2, "foodplace");
							String goodStay = getStrData(eElement2, "goodstay");
							String hanok = getStrData(eElement2, "hanok");
							String infoCenterLodging = getStrData(eElement2, "infocenterlodging");
							String parkingLodging = getStrData(eElement2, "parkinglodging");
							String pickUp = getStrData(eElement2, "pickup");
							String roomCount = getStrData(eElement2, "roomcount");
							String reservationLodging = getStrData(eElement2, "reservationlodging");
							String reservationUrl = getStrData(eElement2, "reservationurl");
							String roomType = getStrData(eElement2, "roomtype");
							String scaleLodging = getStrData(eElement2, "scalelodging");
							String subFacility = getStrData(eElement2, "subfacility");
							String barbecue = getStrData(eElement2, "barbecue");
							String beauty = getStrData(eElement2, "beauty");
							String beverage = getStrData(eElement2, "beverage");
							String bicycle = getStrData(eElement2, "bicycle");
							String campfire = getStrData(eElement2, "campfire");
							String fitness = getStrData(eElement2, "fitness");
							String karaoke = getStrData(eElement2, "karaoke");
							String publicBath = getStrData(eElement2, "publicbath");
							String publicPc = getStrData(eElement2, "publicpc");
							String sauna = getStrData(eElement2, "sauna");
							String seminar = getStrData(eElement2, "seminar");
							String sports = getStrData(eElement2, "sports");
							String refundRegulation = getStrData(eElement2, "refundregulation");
						
							DetailHotel detailHotel = new DetailHotel(contentId, contentTypeId, accomCountLodging, benikia, checkInTime, checkOutTime, chkCooking, 
									foodPlace, goodStay, hanok, infoCenterLodging, parkingLodging, pickUp, roomCount, reservationLodging, reservationUrl, roomType,
									scaleLodging, subFacility, barbecue, beauty, beverage, bicycle, campfire, fitness, karaoke, publicBath, publicPc, sauna, seminar,
									sports, refundRegulation);
							list.add(detailHotel);
	...
	// 정보페이지 url만들어서 넘김 
	public static StringBuffer hotelUrl(String serviceKey, int contentId, int contentTypeId) {
