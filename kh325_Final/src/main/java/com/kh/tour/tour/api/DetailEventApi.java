...
//						System.out.println(contentTypeId);
						...
						if(contentTypeId == 15) {
						URL url2 = new URL(DetailEventApi.eventUrl(serviceKey, contentId, contentTypeId).toString());
...
//							System.out.println(list.toString());
	...
	// 정보페이지 url만들어서 넘김 
	public static StringBuffer eventUrl(String serviceKey, int contentId, int contentTypeId) {
