...
//					System.out.println("\nCurrent Element : " + node.getNodeName());
					if (node.getNodeType() == Node.ELEMENT_NODE) {
						...
						if(contentTypeId == 12) {
						URL url2 = new URL(DetailTouristApi.touristUrl(contentId, contentTypeId).toString());
...
//						System.out.println("\nCurrent Element2 : " + node.getNodeName());
						if (node2.getNodeType() == Node.ELEMENT_NODE) {
							...
							DetailTourist detailTourist = new DetailTourist(contentId, contentTypeId, heritage1, heritage2, heritage3, infoCenter, openDate, 
	...
	// 정보페이지 url만들어서 넘김 
	public static StringBuffer touristUrl(int contentId, int contentTypeId) {
