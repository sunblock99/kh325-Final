...
//						System.out.println(contentTypeId);
						...
						if(contentTypeId == 39) {
						URL url2 = new URL(DetailRestaurantApi.restaurantUrl(serviceKey, contentId, contentTypeId).toString());
...
//							System.out.println(list.toString());
	...
	// 정보페이지 url만들어서 넘김 
	public static StringBuffer restaurantUrl(String serviceKey, int contentId, int contentTypeId) {
