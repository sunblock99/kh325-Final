...
//						System.out.println(contentTypeId);
						...
						if(contentTypeId == 28) {
						URL url2 = new URL(DetailSportsApi.sportsUrl(serviceKey, contentId, contentTypeId).toString());
...
//							System.out.println(list.toString());
	...
	// 정보페이지 url만들어서 넘김 
	public static StringBuffer sportsUrl(String serviceKey, int contentId, int contentTypeId) {
		StringBuffer sportsUrl = new StringBuffer();
		sportsUrl.append(TOUR_TOURLIST_DETAIL_URL);
		sportsUrl.append("?" + "serviceKey=" + serviceKey);
