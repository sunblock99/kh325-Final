...
//						System.out.println(contentTypeId);
						...
						if (contentTypeId == 25) {
							URL url2 = new URL(DetailCourseApi.detailCourseUrl(serviceKey, contentId, contentTypeId).toString());
...
//						System.out.println("\nCurrent Element2 : " + node.getNodeName());
	...
	// 정보페이지 url만들어서 넘김
	public static StringBuffer detailCourseUrl(String serviceKey, int contentId, int contentTypeId) {
		StringBuffer detailCourseUrl = new StringBuffer();
		detailCourseUrl.append(TOUR_RESTAURANT_DETAIL_URL);
		detailCourseUrl.append("?" + "serviceKey=" + serviceKey);
