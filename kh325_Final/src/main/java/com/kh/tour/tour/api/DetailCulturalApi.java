...
//						System.out.println(contentTypeId);
						...
						if(contentTypeId == 14) {
						URL url2 = new URL(DetailCulturalApi.culturalUrl(serviceKey, contentId, contentTypeId).toString());
...
//							System.out.println(list.toString());
	...
	// 정보페이지 url만들어서 넘김 
	public static StringBuffer culturalUrl(String serviceKey, int contentId, int contentTypeId) {
