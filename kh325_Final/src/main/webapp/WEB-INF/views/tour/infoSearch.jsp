...
<body style="padding-top: 90px;">
                        ...
                        <div class="w-100">
                            <div class="row ">
                                <div class="col-lg-12 text-center" style="padding-top: 3rem !important;">
                                    ...
                                    <p class="letter-spacing-1" style="font-size: 1.2rem; justify-content: space-evenly;">투게더에서 가고싶은 관광지를 검색하세요
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <!-- 검색바 시작 -->
    <div style="margin-left: 475px;  flex: 0 0 auto; margin-top: -25px;
    width: 62%;">
        <div class="search-bar rounded p-2 position-relative z-index-20 " style="background-color:white;">
            <form action="#" class="row">
                ...
                <div class="col-lg-3 form-group d-grid mb-0 ">
                    <button class="btn btn-warning h-100" style="background-color: #FFCD4A; border-color: #FFCD4A; font-family: 'pB' !important;" type="submit">Search</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-2 pt-4">
                    <form class="pe-xl-3" action="#" autocomplete="off">
                        <!-- 날짜 체크박스 -->
                        <div class="mb-4">
                            <h6 class="form-label" for="form_dates">Dates</h6>
                        ...
                        <div class="mb-4" style="font-family: 'pB'!important;">
                            <h6 class="form-label" for="form_neighbourhood">LOCATION</h6>
                        ...
                        <!-- TOUR TYPE 체크박스 -->
                        <div class="mb-4">
                            <h6 class="form-label" for="form_category">TOUR TYPE</h6>
                        ...
                        <!-- SERVICE TYPE 체크박스 -->
                        <div class="mb-4">
                            <h6 class="form-label">SERVICE TYPE - 대분류</h6>
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_0" name="type[]">
                                        <label class="form-check-label" for="type_0">자연</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_1" name="type[]">
                                        <label class="form-check-label" for="type_1">인문(문화/예술/역사)</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_2" name="type[]">
                                        <label class="form-check-label" for="type_2">레포츠</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_3" name="type[]">
                                        <label class="form-check-label" for="type_3">쇼핑</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_4" name="type[]">
                                        <label class="form-check-label" for="type_4">음식</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_5" name="type[]">
                                        <label class="form-check-label" for="type_5">숙박</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="type_5" name="type[]">
                                        <label class="form-check-label" for="type_5">추천코스</label>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="pb-4">
                            <div class="collapse" id="moreFilters">
                                ...
                                <!-- 무장애여행 체크박스 -->
                                <div class="filter-block">
                                    <h6 class="form-label">Trip type</h6>
                                    <div class="mb-0">
                                        <div class="form-check form-switch ">
                                            <input class="form-check-input" id="forfamilies" type="checkbox" name="forfamilies" aria-describedby="forfamiliesHelp">
                                            <label class="form-check-label" for="forfamilies"> <span class="text-sm">무장애
                                                여행</span></label>
                                        </div><small class="text-muted form-text" id="forfamiliesHelp">장애인분들까지 편하게 여행 할수 있는
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        <p class="card-title col-md-8" style=" margin-top: 0; margin-bottom: 0.5rem; font-family: 'pEb'; font-weight: 700; font-size: 1.2rem; line-height: 1.3;">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 제주특별자치도 서귀포시 토평동
                                        </p>
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 제주특별자치도 서귀포시 안덕면 산방로 218-10 (안덕면) </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 경기도 광명시 가학로85번길 142 (가학동) </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 서울특별시 종로구 창경궁로 185 (와룡동) </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 충청남도 계룡시 두마면 입암길 218 </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
                        ...
                        <div class="col-sm-6 col-xl-4 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
                            <div class="card h-100 border-0 shadow">
                                <div class="card-img-top overflow-hidden gradient-overlay">
                                    ...
                                    <a class="tile-link" href="detail-rooms.html"></a>
                                    <div class="card-img-overlay-top text-end">
                                        <a class="heart_pink  card-fav-icon position-relative z-index-40" href="javascript: void();">
                                            <i class="fas fa-heart svg-icon"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 경상남도 하동군 화개면 화개로 일원 </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 제주특별자치도 제주시 우도면 우도해안길 252 </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
                            ...
                            <div class="card h-100 border-0 shadow">
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row w-100 txt_line">
                                        ...
                                        <p class="text-sm text-black-50 card-subtitle mb-2 address_short"><i class="fa fa-map-marker text-secondary opacity-4 me-1"></i> 경기도 파주시 광탄면 기산로 365 </p>
                                        <div class=" card-text text-muted overflow-hidden
                                    text-sm text-black-50 txt_line">
