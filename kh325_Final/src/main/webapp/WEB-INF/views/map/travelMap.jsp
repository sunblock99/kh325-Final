...
<header class="header header-absolute fixed-top" style="font-size:30px;">
	                    ...
	                    <div class="py-5 p-xl-2 text-pB">
	                        ...
	                        <form action="#">
	                            ...
	                            <label class="option_item ">
	                                <input type="radio" style="display: none;" class="checkbox" name="place">
	                        ...
	                        <div class=" menu_cont mt-3 text-pB">
	                            <div class="d-flex d-block d-sm-flex review2">
	                                ...
	                                <div class="width100">
	                                    <div class=" text-sm mb-2" style="font-weight: bold; color: #907B65;">${tour.contentTypeName}
	                                    </div>
	                                    <h6 class="py-1 text-lg">
	                                        <!-- 서울 광장 -->
	                                        <!-- <a class="text-decoration-none text-dark" href="">서울광장</a> -->
	                                        <a href="#" class="a-orign-text" onclick="onDisplay();">${tour.title}</a>
	                                        <!-- <input type="button" value="서울광장"> -->
	                                    </h6>
	                                    <div class="text-muted text-sm">${tour.addr1}</div>
	                            ...
	                            <div class="d-flex d-block d-sm-flex review2">
	                                <div class="text-md-center flex-shrink-0 me-4 me-xl-5"><img
	                                        class="d-block picSize round "
	                                        src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&amp;id=1210da0d-f8fb-4299-9842-de6b69410354">
	                                </div>
	                                <div class="width100">
	                                    <div class=" text-sm mb-2" style="font-weight: bold; color: #907B65">관광지
	                                    </div>
	...
	//                 {
	//                     title: '${tour.title}',
	//                     latlng: new kakao.maps.LatLng(${tour.mapY}, ${tour.mapX}),
