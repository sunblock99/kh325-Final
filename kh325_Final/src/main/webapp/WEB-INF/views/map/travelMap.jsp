...
<head>
    ...
    <!-- <link rel="stylesheet" href="css/style.myMap.css" id="theme-stylesheet"> -->
            ...
            <div class="row">
                <div class="col-lg-4 py-4 p-xl-4">
                    <div class="py-5 p-xl-2 text-pB">
                        ...
                        <h6 class="ms-2 fw-bold text-center pt-4" style="color: #907B65;"> &nbsp; TOGETHER</h6>
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="pc_depth1 text-center">
                                    <div class="map_menu my-2">
                                        <!-- <strong class="stit_area"></strong> -->
                                        <tr class="tab">
                                            <td>
                                                <label class="option_item">
                                                <input type="checkbox" class="checkbox" checked name="place">
                                                <div class="option_inner travel">
                                                    <div class="icon ">
                                                        <!-- <img class="travel" src="pic/travel.png" style="width: 100%; "> -->
                                                        <i class="fa-solid fa-map-location-dot"></i>
                                                    </div>
                                                    <div class="name">여행지</div>
                                                </div>
                                            </label>
                                            </td>
                                            <td>
                                    ...
                                    <tr class="tab">
                                        ...
                                        <td>
                                            <label class="option_item">
                                            <input type="button" class="button" name="allNonChk">
                                            <div class="option_inner" style="cursor: default;">
                        ...
                        <!-- 커스텀오버레이 -->
                        <!-- <div class="d-flex d-block d-sm-flex modal-body" id="clickMarkerInfo">
                        <div class="text-md-center flex-shrink-0 me-4 me-xl-5"><img class="d-block picSize round " src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&amp;id=1210da0d-f8fb-4299-9842-de6b69410354">
                        </div>
                        <div class="width100">
                            <div class=" text-sm mb-2" style="font-weight: bold; color: #907B65;">관광지</div>
                            <h6 class="py-1 text-lg">
                                <a href="#" onclick="onDisplay();">카카오 스페이스닷원</a>
                            </h6>
                            <div class="text-muted text-sm">제주특별자치도 제주시 첨단로 242</div>
                        </div>
                    </div> -->

                        <!-- <div class="wrap" id="popup_map">
                        <div class="info">
                            <div class="title">
                                카카오 스페이스닷원
                                <div class="close" id="closeBtn" onclick="closeOverlay()" title="닫기"></div>
                            </div>
                            <div class="body">
                                <div class="img">
                                    <img src="https://t1.kakaocdn.net/jewika/images/v1/kakaospace01.jpg" width="73" height="70">
                                </div>
                                <div class="desc">
                        ...
                        <div class=" menu_cont mt-3 text-pB">
                            <div class="d-flex d-block d-sm-flex review2">
                                ...
                                <div class="width100">
                                    ...
                                    <h6 class="py-1 text-lg">
                                        <!-- 서울 광장 -->
                                        <!-- <a class="text-decoration-none text-dark" href="">서울광장</a> -->
                                        <a href="#" class="a-orign-text" onclick="onDisplay();">카카오 스페이스닷원</a>
                                        <!-- <input type="button" value="서울광장"> -->
                                    </h6>
                                    <div class="text-muted text-sm">제주특별자치도 제주시 첨단로 242</div>
                                    <div class="pe-4 pt-1 float-end">
                                        <!-- <i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-gray-300"></i><i class="fa fa-xs fa-star text-gray-300"></i> -->
                            ...
                            <div class="d-flex d-block d-sm-flex review2">
                                ...
                                <div class="width100">
                                    <div class=" text-sm mb-2" style="font-weight: bold; color: #907B65">관광지</div>
                                    <h6 class="py-1 text-lg">카카오 생태연못</h6>
                                    <div class="text-muted text-sm">제주특별자치도 제주시 첨단로 242</div>
                                    <div class="pe-4 pt-1 float-end">
                            ...
                            <div class="d-flex d-block d-sm-flex review2">
                                ...
                                <div class="width100">
                                    <div class=" text-sm mb-2" style="font-weight: bold; color: #907B65">관광지</div>
                                    <h6 class="py-1 text-lg">서울 광장</h6>
                                    <div class="text-muted text-sm">서울특별시 중구 세종대로 110 </div>
                                    <div class="pe-4 pt-1 float-end">
                                        <!-- <i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i> -->
                                        <!-- <br> -->
                                        <i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300"></i><i class="fa fa-star text-gray-300"></i>
                            ...
                            <div class="d-flex d-block d-sm-flex review2">
                                ...
                                <div class="width100">
                                    ...
                                    <h6 class="py-1 text-lg">서울 광장</h6>
                                    <div class="text-muted text-sm">서울특별시 중구 세종대로 110 </div>
                                    <div class="pe-4 pt-1" style="float: right;">
                                        <!-- <i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i> -->
                                        <!-- <br> -->
                                        <i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300"></i><i class="fa fa-star text-gray-300"></i>
                                    </div>
                    ...
                    <!-- 지도 크기 -->
                    <div class="col-lg-8 map-side-lg pe-lg-0 pt-3">
