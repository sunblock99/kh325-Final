    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <a href="index.html" class="logo text-center logo-light">
                <span class="logo-lg">
                        <img src="assets/images/custom/togetherLogoWhite.png" alt="" height="50">
                    </span>
                <span class="logo-sm">
                        <img src="assets/images/custom/togetherLogo_icon.png" alt="" height="16">
                    </span>
            </a>
                                        ...
                                        <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="https://www.iscu.ac.kr/main/images/contents/03_aboutschool/06_01_top_tit.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-16">
                                                            <a href="apps-ecommerce-products-details.html" class="text-body">가족들과 함께해서 너무 즐거웠어요</a>
                                                            <br/>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="https://www.iscu.ac.kr/main/images/contents/03_aboutschool/06_01_top_tit.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-16">
                                                            <a href="apps-ecommerce-products-details.html" class="text-body"> 함께해서 너무 즐거웠어요</a>
                                                            <br/>
                                                            <span class="text-warning mdi mdi-star"></span>
                                                            <span class="text-warning mdi mdi-star"></span>
                                                            <span class="text-warning mdi mdi-star"></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="https://www.iscu.ac.kr/main/images/contents/03_aboutschool/06_01_top_tit.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />
                                                        <p class="m-0 d-inline-block align-middle font-16">
                                                            <a href="apps-ecommerce-products-details.html" class="text-body">거제와 함께해서 너무 즐거웠어요</a>
                                                            <br/>
                                                            <span class="text-warning mdi mdi-star"></span>
                                                            <span class="text-warning mdi mdi-star"></span>
                                                            <span class="text-warning mdi mdi-star"></span>
