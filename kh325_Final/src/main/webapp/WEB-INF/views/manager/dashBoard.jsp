                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h4 class="header-title">신고게시판</h4>
                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="mdi mdi-dots-vertical"></i>
                                            </a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);" class="text-body">나는문어 꿈을꾸는문어</a></h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted font-13">Status</span> <br/>
                                                        <span class="badge badge-warning-lighten">미처리</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="font-14 mt-1 fw-normal">자유게시판</h5>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);" class="text-body">[블라인드된] ㅇㅇ으이에</a></h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted font-13">Status</span> <br/>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);" class="text-body">머하지</a></h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted font-13">Status</span> <br/>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="font-14 my-1"><a href="javascript:void(0);" class="text-body">KH정보교육원</a></h5>
                                                    </td>
                                                    <td>
                                                        <span class="text-muted font-13">Status</span> <br/>
                                                        <span class="badge badge-warning-lighten">미처리</span>
