            ...
            <div class="col-lg-auto">
              ...
              <div class="text-block">
                    ...
                    <div class="d-flex d-block d-sm-flex review" style="padding-top: 1rem; padding-bottom: 1rem;">
                        <div class="text-md-center flex-shrink-0 me-4 me-xl-5"><img class="d-block avatar avatar-xl p-2 mb-2" src="${MyCourseRev.userAvatar}"><span class="text-uppercase text-muted text-sm"></span></div>
                        <div>
