        ...
        <div class="container-fluid">
          <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand py-3 px-5" href="index.html"
              style="line-height:0;">
              <img class="ps-3" src="${path}/resources/image/togetherLogoWhite.png" width="30%"
                height="10%">
            </a>
            <!-- 로고 끝-->
          ...
          <div class="collapse navbar-collapse px-6 " id="navbarCollapse"
            ...
            <ul class="navbar-nav ms-auto">
              <li class="nav-item dropdown">
                <a class="nav-link-header" id="homeDropdownMenuLink"
                  href="index.html"
              ...
              <li class="nav-item position-static">
                <li class="nav-item dropdown">
                  <a class="nav-link-header dropdown-toggle me-3" id="docsDropdownMenuLink"
              ...
              <li class="nav-item"><a class="nav-link-header" href="${path}/loginView">로그인</a></li>
              </c:if>
