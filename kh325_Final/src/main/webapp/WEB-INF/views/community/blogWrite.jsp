                ...
                <div class="row">
                    <div class="px-lg-7 px-3">
                        ...
                        <div class="mb-3 py-2 text-end text-pM">
                            <a href=""><img class="avatar p-1 me-2" src="img/avatar/avatar-11.jpg" alt=""></a>
                             Written by <a class="fw-bold" href="#" style="color: #907B65;">맥가이버</a><span class="mx-1">|</span> 
                             January 16, 2016 <span class="mx-1">|</span>
                        </div>
                        ...
                        <div class="mb-3 text-pB border-bottom pb-4">
                            <div class="row">
                                ...
                                <div class="col-lg-8 mx-auto ">
                                    <input type="text" class=" form-control bg-gray-100 " name="tagList" id="tagList" value="#가을, #행복, #섬진강," disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row pt-3">
