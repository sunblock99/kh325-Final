            ...
            <div class="card_title pt-7">
              ...
              <div class="pb-">
                <div class="collapse" id="addPictures">
                  <!-- 파일업로드 테스트 -->
                <form action="${path}/community/writeGallery" method="post" enctype="multipart/form-data">
                  <div id="root">
                    <div class="contents mb-4">
                      ...
                      <input class="form-control-addTag " style="top:0;" type="text" name="title" placeholder="제목을 입력해주세요" id="form_title">
                      <input class="form-control-addTag " style="top:30%;" type="text" name="tag" placeholder="태그를 입력해주세요" id="form_tag">
											<input type="text" name="writerId" value="${loginMember.id}" readonly style="display: none" >
                      ...
                      <div class="uploadButtons">
                        ...
                        <button class="upbtn file-label btn_submit" type="submit"><i class="fa-solid fa-cloud-arrow-up"></i>&nbsp; Upload</button>
                      </div>
                    </div>
                    </div>
                  </div>
...
<%-- 								<c:if test="${loginMember != null}"> --%>
	                <div class="mt-3">
	                  <button class="btn btn-link btn-collapse text-secondary fs-6" type="button" data-bs-toggle="collapse" data-bs-target="#addPictures" aria-expanded="false" aria-controls="addPictures" data-expanded-text="접기" data-collapsed-text="이미지 게시하기">이미지 게시하기</button>
	                </div>
<%-- 								</c:if> --%>
          ...
          <fieldset>
            ...
            <div class="inner-form ">
              <div class="input-field shadow" style="border-radius: 50%;">
                <input class="form-control " id="searchValue" name="searchValue" type="text" placeholder="Type to search..." value="${param.searchValue}" />
...
<!--               <select> -->
              <select class="selectpicker" name="sort" id="form_sort" data-style="btn-selectpicker" title="">
                ...
                <option value="sortBy_2">Most popular </option>
              </select>
            </div>
          </div>
          <div class="row">
            <div class=" grid-wrapper pb-3">
              <div class="box">
                ...
                style="background-image: url(${gallery.renamedImage});">
                  <div class="info card-img-overlay-bottom z-index-50">
                    ...
                    <c:if test="${loginMember != null}">
	                    <c:choose>
	                    <c:when test="${ !empty loginMember && (loginMember.id == gallery.uno || loginMember.role == 'ROLE_ADMIN') }">
              ...
              <div class="box">
                ...
                <div class="gallery-defalt card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://t1.daumcdn.net/cfile/tistory/99E937495DCE453C31);">
                  <div class="info card-img-overlay-bottom z-index-50">
              ...
              <div class="tall box">
                ...
                <div class="gallery-tall card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://t1.daumcdn.net/cfile/blog/2668933953157BC916);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="wide box">
                ...
                <div class="gallery-wide card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://blog.kakaocdn.net/dn/bVQKdP/btqGgkxfDTy/bX20mCxhBG68oFlRWlpMgK/img.jpg);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="box">
                ...
                <div class="gallery-defalt card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1558980663-3685c1d673c4?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1000&amp;q=60);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="tall box">
                ...
                <div class="gallery-tall card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1588499756884-d72584d84df5?ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=2134&amp;q=80);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="big box">
                <!-- <img src="https://t1.daumcdn.net/cfile/blog/2668933953157BC916" alt="" /> -->
                <div class="gallery-big card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://t1.daumcdn.net/cfile/blog/2668933953157BC916);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="box">
                ...
                <div class="gallery-defalt card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1588247866001-68fa8c438dd7?ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=564&amp;q=80);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="tall box">
                ...
                <div class="gallery-tall card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1588224575346-501f5880ef29?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=700&amp;q=80);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="box">
                ...
                <div class="gallery-defalt card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1588414734732-660b07304ddb?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=675&amp;q=80);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="wide box">
                ...
                <div class="gallery-wide card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1547234935-80c7145ec969?ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1353&amp;q=80);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
              ...
              <div class="box">
                ...
                <div class="gallery-defalt card-img-top overflow-hidden bg-cover" onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)" style="background-image: url(https://images.unsplash.com/photo-1547234935-80c7145ec969?ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1353&amp;q=80);">
                  <div class="info card-img-overlay-bottom z-index-50">
                    <h4 class="text-white text-shadow-dark" style="float: left;">Blue Hill</h4>
                    <a href=" " data-bs-toggle="modal" data-bs-target="#exclaim" class=" text-white" style="float: right;"><i class="fa-solid fa-bullhorn fas "></i></a>
                    <a href="#;" onclick="deletePic();" class=" text-white" style="float: right;"><i class="fa-regular fa-trash-can"></i></a>
            ...
            <nav aria-label="Page navigation example ">
              <ul class="pagination pagination-template d-flex justify-content-center p-5">
                <li class="page-item ">
                	<button class="page-link" onclick="movePage('${path}/community/gallery?page=1');">&lt;&lt;</button>
<!--                   <a class="page-link" href="#"><span style="color: #000000;">&lt;&lt;</span></a> -->
                </li>
                <li class="page-item ">
                	<button class="page-link" onclick="movePage('${path}/community/gallery?page=${pageInfo.prevPage}');">&lt;</button>
                </li>
                <li class="page-item">
                ...
                <c:forEach begin="${pageInfo.startPage}" end="${pageInfo.endPage}" step="1" varStatus="status">
  	              ...
  	              <li class="page-item">
									...
									<c:if test="${pageInfo.currentPage != status.current}">
		                <li class="page-item">
											<button class="page-link" onclick="movePage('${path}/community/gallery?page=${status.current}');">
                ...
                <li class="page-item">
									<button class="page-link" onclick="movePage('${path}/community/gallery?page=${pageInfo.nextPage}');">&gt;</button>
                </li>
                <li class="page-item">
									<button class="page-link" onclick="movePage('${path}/community/gallery?page=${pageInfo.maxPage}');">&gt;&gt;</button>
<!--                   <a class="page-link" href="#"><span style="color: #000000;">&gt;&gt;</span></a> -->
                </li>
              </ul>
            </nav>
  ...
  <!-- 내꺼 js -->
<%--   <script src="${path}/resources/js/addSearch.js"></script> --%>
